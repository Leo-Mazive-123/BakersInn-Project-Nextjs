    ...
    <main>
      <div className="ml-5 flex justify-between">
        <div className="items-center justify-center mt-40">
          <h1 className="font-bold text-5xl text-[#00184C]">
        ...
        <div className="flex gap-2 justify-end">
          <div>
            <Image src="/recipe1.png" alt="Recipe 1" width={240} height={240} />
            <Image src="/recipe3.png" alt="Recipe 3" width={240} height={240} />
          </div>
